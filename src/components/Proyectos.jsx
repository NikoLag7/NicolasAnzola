    ...
    return (
      <div className='flex flex-col gap-5'>
        ...
        <div className='proyectosPrincipal p-2 rounded text-slate-300 flex flex-col gap-2'>
          ...
          <p className='text-xs'>Este proyecto fue desarrollado principalmente con Bubble.io y consiste en un sistema interno diseñado para gestionar ventas, facturación y pedidos. Su objetivo es optimizar los procesos operativos, brindando una solución personalizada y eficiente para el control y seguimiento de las actividades comerciales.</p>
          <div className='flex flex-row gap-2'>
        ...
        <div className='proyectosPrincipal p-2 rounded text-slate-300 flex flex-col gap-2'>
          ...
          <p className='text-xs'>Este proyecto es una tienda e-commerce desarrollada en WordPress, con un diseño de interfaz realizado en Elementor y la gestión del backend a través de WooCommerce. Se trata de un proyecto real, creado a partir de un análisis detallado de los requerimientos del cliente, eligiendo las tecnologías más adecuadas para satisfacer sus necesidades y garantizar una solución eficiente y funcional.</p>
          <div className='flex flex-row gap-2'>
        ...
        <div className='proyectosPrincipal p-2 rounded text-slate-300 flex flex-col gap-2'>
          ...
          <p className='text-xs'>Este proyecto, realizado en 2022, fue mi primer acercamiento a React. Me permitió aprender los conceptos básicos del framework y sentó las bases para desarrollar aplicaciones más complejas. A través de este proyecto, pude explorar la estructura de componentes y el manejo del estado</p>
          <div className='flex flex-row gap-2'>
            <div className='flex w-auto text-xs items-center text-slate-500  gap-1 hover:text-slate-300'><IoBulb /><a target="_blank" href='#'>Demo</a></div>
          </div>
